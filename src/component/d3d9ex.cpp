...
{
	dvar::register_var<bool>("r_used3d9ex", true, game::DVAR_FLAG_SAVED, "Use extended d3d9 interface!");

	// Hook Interface creation
	utils::hook(0x673E06, d3d9ex::Direct3DCreate9Stub).install()->quick();
}

REGISTER_COMPONENT(d3d9ex);
